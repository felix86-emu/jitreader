...
typedef struct gdb_block*(gdb_block_open)(struct gdb_symbol_callbacks* cb, struct gdb_symtab* symtab, struct gdb_block* parent, GDB_CORE_ADDR begin,
...
typedef enum gdb_status(gdb_target_read)(GDB_CORE_ADDR target_mem, void* gdb_buf, int len);
...
typedef enum gdb_status(gdb_read_debug_info)(struct gdb_reader_funcs* self, struct gdb_symbol_callbacks* cb, void* memory, long memory_sz);
...
typedef enum gdb_status(gdb_unwind_frame)(struct gdb_reader_funcs* self, struct gdb_unwind_callbacks* cb);
...
typedef struct gdb_frame_id(gdb_get_frame_id)(struct gdb_reader_funcs* self, struct gdb_unwind_callbacks* c);
